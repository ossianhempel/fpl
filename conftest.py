...
def gameweeks_data() -> pd.DataFrame:
    ...
    data_20_21 = pd.read_csv(
        os.path.join("tests", "test_data", "test_merged_gw_20_21.csv")
    )
    data_23_24 = pd.read_csv(
        os.path.join("tests", "test_data", "test_merged_gw_23_24.csv")
    )
    data_24_25 = pd.read_csv(
        os.path.join("tests", "test_data", "test_merged_gw_24_25_3.csv"),
        on_bad_lines="skip",
    )
...
def teams_data() -> pd.DataFrame:
    ...
    data = pd.read_csv(
        os.path.join("tests", "test_data", "test_teams_2019_20_with_season.csv")
    )
    return data
