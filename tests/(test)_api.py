...
from src.fastapi.api import app
...
def test_ingest_fixtures(mock_ingest):
    ...
    response = client.post("/ingest/fixtures", json={"source": "fixtures"})
...
def test_ingest_gameweeks(mock_ingest):
    ...
    response = client.post("/ingest/gameweeks", json={"source": "gameweeks"})
...
def test_ingest_teams():
    ...
    response = client.post("/ingest/teams", json={"source": "teams"})
...
def test_ingest_source_mismatch():
    ...
    response = client.post("/ingest/fixtures", json={"source": "gameweeks"})
...
def test_ingest_invalid_source():
    ...
    response = client.post("/ingest/invalid", json={"source": "invalid"})
