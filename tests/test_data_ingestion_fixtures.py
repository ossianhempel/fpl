...
def test_transform_and_dedupe_data(data_ingestion: DataIngestion, fixtures_data: pd.DataFrame, teams_data: pd.DataFrame) -> None:
...
def test_transform_with_missing_columns(data_ingestion: DataIngestion, fixtures_data: pd.DataFrame, teams_data: pd.DataFrame) -> None:
...
def test_transform_with_duplicates(data_ingestion: DataIngestion, fixtures_data: pd.DataFrame, teams_data: pd.DataFrame) -> None:
...
def test_validate_data(data_ingestion: DataIngestion, fixtures_data: pd.DataFrame, teams_data: pd.DataFrame) -> None:
...
def test_initiate_data_ingestion(mock_fetch: MagicMock, data_ingestion: DataIngestion, fixtures_data: pd.DataFrame, teams_data: pd.DataFrame) -> None:
...
def test_complete_ingestion_process(mock_engine: Mock, mock_postgres: Mock, data_ingestion: DataIngestion, fixtures_data: pd.DataFrame, teams_data: pd.DataFrame) -> None:
...
def test_transform_with_incorrect_data_types(
...
def test_transform_with_partially_invalid_data(
        data_ingestion: DataIngestion, 
        fixtures_data: pd.DataFrame, 
        teams_data: pd.DataFrame,
        ) -> None:
